               ...
               <IonRow>
                    <IonCol size='10'>
                        <IonCardHeader className='felicitaciones-header'>
                            <IonCardTitle className='felicitaciones-title' style={{  textAlign: 'left' }}>
                                ¡Felicitaciones!
                            </IonCardTitle>
                            ...
                            <div id='congrats-text-reg'>You've created and read five stories. Can you keep going?</div>
                        </IonCardHeader>
                    </IonCol>
                </IonRow>
            </IonGrid>    
            ...
            <IonRow class="ion-justify-content-center">
                <IonCol class="ion-text-center">
                    <div style={{ position: 'relative' }}>
                        <IonButton className='sigue-adelante-button' shape='round' style={{ position: 'absolute', bottom: '-4vh', left: '50%', transform: 'translateX(-50%)' }}>
                            <div>
