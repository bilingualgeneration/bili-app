                    ...
                    <IonCol>
                        <IonCardHeader className='story-header'>
                            <IonCardTitle style={{  textAlign: 'left' }}>
                              <div id='story-page-2-title'> Esta es tu fábrica de cuentos. Puedes crear un cuento 
                                                  presionando el botón Actualizar o deslizando o haciendo clic en cada sección de la historia.
                              </div>
                            </IonCardTitle>
                            <IonCardSubtitle>
                              <div id='story-page-2-subtitle'>This is your story factory. You can create a story by either hitting the Refresh 
                                                  button, or by swiping or clicking each section of the story.
                              </div> 
                            </IonCardSubtitle>
                        </IonCardHeader>
                        ...
                        <IonCol class="ion-text-center">
                          <div className='mini-fabrica-card-page-3'>
                            <img src={miniFabricaCard} alt='Miniature display of the fabrica card slot game' />
                          </div>
                        </IonCol>
