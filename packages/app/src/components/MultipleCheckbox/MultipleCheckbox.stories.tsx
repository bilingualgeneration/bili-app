...
import { MultipleCheckbox, MultipleCheckboxOption } from "./MultipleCheckbox";
...
const meta: Meta<typeof MultipleCheckbox> = {
  ...
  render: (props) => {
    const schema = z.object({
      field: z
        .string() // todo: allow numbers? other values?
        .array(),
    });
    ...
    return (
      <>
        <MultipleCheckbox
          ...
          options={options}
        />
        <div className="ion-margin-top">value of field: {field.join(", ")}</div>
      </>
    );
  },
};
