      ...
      >
        <IonGrid class="ion-no-padding">
              ...
              <div className="up-button">
                ...
                >
                  <path
                    ...
                    fill={`#${colorOptionsArrows[index]}`} // Dynamically set fill based on array option
                  />
                </svg>
              </div>
            </IonCol>
          ...
          <IonRow class="ion-justify-content-center">
            <IonCol>
              <div className={`sf-game-option-1 ${colorOptionsOvals[index]}`}>
                <p className="fabrica-text1-spanish">{es}</p>
                {!isImmersive && <p className="fabrica-text2-english">{en}</p>}
              </div>
            </IonCol>
          </IonRow>
