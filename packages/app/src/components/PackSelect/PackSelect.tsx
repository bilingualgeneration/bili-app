...
export const HydratedPackSelect: React.FC<props> = ({
  ...
  if (only_cards) {
    return (
      <>
        <Carousel slidesToShow={screenType === "mobile" ? 1 : 2} height={274}>
  ...
  return (
    <>
      ...
      <div className="background-card">
          ...
          <IonText>
            <h1
              style={{
                ...
                marginBottom: screenType === "mobile" ? "-0.15rem" : "",
              }}
              className={`${
                screenType === "mobile" ? "text-1_5xl" : "text-5xl"
            ...
            {language === "esen" && (
              <h2
                style={{
                  marginLeft: screenType === "mobile" ? "5px" : "30px",
                  marginBottom: screenType === "mobile" ? "-1.2rem" : "", // Adjust this value as needed
                }}
                className={`${
        ...
        <Carousel
          slidesToShow={screenType === "mobile" ? 1 : 2} // Adjust slides for mobile
          height={screenType === "mobile" ? 145 : 274} // Adjust height for mobile
        >
          {cards.map((c: Card, index: number) => (
            <ContentCard {...c} key={index} />
          ))}
